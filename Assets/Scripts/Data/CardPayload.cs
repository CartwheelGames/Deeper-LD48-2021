...
public class CardPayload
{
	...
	public CardPayload(Card currentCard, Color backgroundColor, Sprite acceptFeedback, Sprite rejectFeedback, string outcomeText)
	{
		_card = currentCard;
	...
	public Sprite Location => _card.Location;
